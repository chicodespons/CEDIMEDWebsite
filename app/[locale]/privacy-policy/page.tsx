...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CEDIMED Brussels, Avenue du Laerbeek 101, Jette.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to CEDIMED Brussels, accessible from <a href="https://lobster-app-fkcxb.ondigitalocean.app/" rel="external nofollow noopener" target="_blank">https://lobster-app-fkcxb.ondigitalocean.app/</a></p>
</li>
<li>
...
<ul>
<li>By email: info@cedimed.brussels</li>
</ul>
  `;
    ...
    <section className="py-14 bg-white mt-2">
      <div className="container mx-auto">
        <div className="bg-gray-100 p-4 mx-4 lg:mx-32 rounded text-justify">
          ...
          {/* 
            Safely render the HTML. This is static, so the risk is lower,
            but be mindful of potential XSS if the source is untrusted.
          */}
          <div
            className="prose prose-lg max-w-none px-4 py-2"
