    ...
    <div className="px-6 py-14 mt-2 bg-white text-gray-800 max-w-4xl mx-auto">
      ...
      <p className="mb-6">
        ...
        <a
          ...
          className="text-uzGreen underline hover:text-uzGray"
        >
      ...
      <h2 className="text-2xl font-semibold mb-4 text-uzGreen">
      ...
      <ul className="list-disc pl-6 space-y-2 mb-6">
        ...
        <li>
          <p>
            <strong>Website</strong> refers to CEDIMED Brussels, accessible from{" "}
            <a
              href="https://lobster-app-fkcxb.ondigitalocean.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-uzGreen underline hover:text-uzGray"
            >
              https://lobster-app-fkcxb.ondigitalocean.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <p className="text-sm text-gray-600">
        For more details, please review the full Privacy Policy above or contact
        us at{" "}
        <a
          href="mailto:info@cedimed.brussels"
          className="text-uzGreen underline hover:text-uzGray"
        >
