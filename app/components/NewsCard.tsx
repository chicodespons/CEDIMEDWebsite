...
const NewsCard: React.FC<{ newsItem: NewsItem; locale: string }> = ({ newsItem, locale }) => {
  ...
  return (
    <Link href={`/${locale}/news/${slug}`}>
      <div className="group bg-white rounded-lg shadow-lg overflow-hidden flex flex-col transition duration-300 ease-in-out transform hover:bg-uzGreen active:bg-grayBack h-full">
        {/* Image Section */}
